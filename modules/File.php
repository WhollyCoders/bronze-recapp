...
// *** Check if file is a CSV FIle ***
        public function check_for_csv($file_array)
        {
            if($this->get_file_type($file_array) == 'csv')
            {
                return true;
            }else
            {
...
// *** Create Contacts Table If it does NOT exist ***
        ...
        // }
// *** Get File Name ***
        public function get_file_name($file_array)
        {
            $this->File_array = $file_array;
            return $this->File_array['file']['name'];
        }
// *** Get File Type ***
        public function get_file_type($file_array)
        {
            $filename = $this->get_file_name($file_array);
...
// *** Import CSV Data ***
        public function import_csv($file_array)
        {
            if($this->check_for_csv($file_array))
            {
                
                $filename = $this->get_tmp_file($file_array);
                ...
                while($data = fgetcsv($handle))
                {
                    ...
                    echo $competitor_name       = $WeighIn->Competitor->get_competitor_by_id($competitor_id);
